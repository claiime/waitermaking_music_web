...
namespace Music_Web.Areas.Admin.Models.BusinessModel
{
    public class ReflectionController
    {
        ...
        public List<string> GetActions(Type controller)
        {
            ...
            IEnumerable<MemberInfo> memberInfo = controller.GetMethods(BindingFlags.Instance | BindingFlags.DeclaredOnly | BindingFlags.Public).Where(m => !m.GetCustomAttributes
